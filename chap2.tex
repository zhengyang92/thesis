...
\item Platform-independent peephole optimizations:


LLVM includes a set
  of platform-independent peephole optimizations that can transform
  scalar code into vectorized code. These optimizations are applied at
  the LLVM IR level and can improve the performance of vector
  operations.
