...
\begin{table}[tbp]
  \centering
  \caption{Operations that \minotaur{} can synthesize. The data movement
  and SIMD intrinsic instructions require vector operands. The rest
  of the operations apply to both scalar and vector values.}
  \begin{tabular}{ r | l }
    \textbf{Operation Type} & \textbf{Instructions} \\
    \hline
    Unary integer & ctpop, ctlz, cttz, bitreverse, bswap \\
    Unary floating point & fneg, fabs, fceil, ffloor, frint, fround, fnearbyint, froundeven \\
