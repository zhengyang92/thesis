...
\begin{table}[t]
  \centering
  \caption{\minotaur's effect on compilation time}
  \begin{tabular}{r | r r r | r r | r r r | r r}
    \multirow{2}{*}{} & \multicolumn{5}{c|}{Intel Cascade Lake} & \multicolumn{5}{c}{AMD Zen 3} \\
    %\cline{2-11}
    & \multicolumn{3}{c|}{Compile time (minutes)} & \multicolumn{2}{c|}{Stats} & \multicolumn{3}{c|}{Compile time (minutes)} & \multicolumn{2}{c}{Stats}  \\
    %\hline
    Benchmarks & Cold & Warm & Clang & \# Cuts & \# Opts. & Cold & Warm & Clang & \# Cuts & \# Opts. \\
    \hline
