...
13\%. On SPEC CPU 2017, \tool{} produces an average speedup of 1.5\%,
...
used as a drop-in replacement for NCCL. SCCL synthesizes novel
algorithms that are not seen in the literature on two popular hardware
topologies. The generated algorithms are competitive with hand
optimized libraries such as NCCL and RCCL.
