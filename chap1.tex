...
My thesis is as follows: Program synthesis can help developers to better
utilize novel instructions and features on emerging architectures.
Specifically, by leveraging program synthesis techniques, we can
automatically generate optimal collective algorithms that can be proven
to be correct and optimal for a specific topology, and we can also
