...
set terminal pdf enhanced size 3.4,2.8 font "Times-Roman,11" lw 1

set style line 2 lc rgb 'black' lt 1 lw 1
set output "optimization-count.pdf"
...
plot "loop.csv" using 1:4:xticlabels(1) notitle with linespoints ls 1 lc rgb "#475468"
