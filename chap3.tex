...
platform independent vector instructions, and a large number of
Intel-architecture-specific vector intrinsics.
%
...
\section{Supporting Floating Point Instructions in Alive2}

LLVM's floating point instructions trivially map to the IEEE-754
...
\section{Supporting Platform Independent SIMD operations in Alive2}
...
\section{Supporting Intel Architecture Specific SIMD Intrinsics in Alive2}
