...
\item Lopes, N. P., Lee, J., Hur, C.-K., Liu, Z., and Regehr, J. Alive2: Bounded
translation validation for LLVM. In \textit{Proceedings of the SIGPLAN
Conference on Programming Language Design and Implementation} (2021),
pp. 65–79, DOI: 10.1145/3453483.3454030~\cite{alive2}.
\end{itemize}
